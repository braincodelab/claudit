...
class DICOMSort(object):
    ...
    def rename_file(self, file):
        ...
        try:
            ...
            print('pydicom.read_file() IO error on file %s, exception %s' % (file, str(why)) )
            return False
        ...
        try:
            ...
            print( "Dicom file copy IO error on output pathname >%s< Exception >%s<" % (path, str(why)) ) 
        ...
        if target_path in self.renamed_files:
            ...
            self.renamed_files[target_path] = [target_filename,]
        return True
